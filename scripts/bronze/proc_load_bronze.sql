...
BEGIN
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','crm_cust_info', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_crm/cust_info.csv');
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','crm_prd_info', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_crm/prd_info.csv');
    t_end := clock_timestamp();
    dur := EXTRACT(EPOCH FROM t_end - t_start);
    RAISE NOTICE '>> Load Duration: % seconds', round(dur::numeric,3);
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','crm_sales_details', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_crm/sales_details.csv');
    t_end := clock_timestamp();
    dur := EXTRACT(EPOCH FROM t_end - t_start);
    RAISE NOTICE '>> Load Duration: % seconds', round(dur::numeric,3);
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','erp_loc_a101', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_erp/loc_a101.csv');
    t_end := clock_timestamp();
    dur := EXTRACT(EPOCH FROM t_end - t_start);
    RAISE NOTICE '>> Load Duration: % seconds', round(dur::numeric,3);
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','erp_cust_az12', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_erp/cust_az12.csv');
    t_end := clock_timestamp();
    dur := EXTRACT(EPOCH FROM t_end - t_start);
    RAISE NOTICE '>> Load Duration: % seconds', round(dur::numeric,3);
    ...
    EXECUTE format('COPY %I.%I FROM %L WITH (FORMAT csv, HEADER true)', 'bronze','erp_px_cat_g1v2', 'p:/Project/SQL/sql-data-warehouse-project-main/datasets/source_erp/px_cat_g1v2.csv');
    t_end := clock_timestamp();
    dur := EXTRACT(EPOCH FROM t_end - t_start);
    RAISE NOTICE '>> Load Duration: % seconds', round(dur::numeric,3);
